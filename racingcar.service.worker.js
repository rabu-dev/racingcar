...
/** @type {string} */
const CACHE_VERSION = '1783006345|8792845';
/** @type {string} */
const CACHE_PREFIX = 'racingcar-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'racingcar.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["racingcar.html","racingcar.js","racingcar.offline.html","racingcar.icon.png","racingcar.apple-touch-icon.png","racingcar.audio.worklet.js","racingcar.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["racingcar.wasm","racingcar.pck"];
